...
def give_mysql_env():
    load_dotenv("/home/hamed/projects/ReactBlogWebApp/db_init_library/env/rootdata/.env.sql.internals")
    load_dotenv("/home/hamed/projects/ReactBlogWebApp/db_init_library/env/userdata/.env.sql.internals")
