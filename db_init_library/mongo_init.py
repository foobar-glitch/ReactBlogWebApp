...
def give_mongo_env():
    load_dotenv("/home/hamed/projects/ReactBlogWebApp/db_init_library/env/rootdata/.env.mongo.internals")
    load_dotenv("/home/hamed/projects/ReactBlogWebApp/db_init_library/env/userdata/.env.mongo.internals")
